...
window.onkeydown = function(ev) {
    if (ev.code === "KeyW") { type = 3; dy=-1}
    if (ev.code === "KeyS") { type = 0; dy=1}
    if (ev.code === "KeyA") { type = 1; dx=-1}
    if (ev.code === "KeyD") { type = 2; dx=1}
}

window.onkeyup = function(ev) {
    if (ev.code === "KeyW") { dy=0 }
    if (ev.code === "KeyS") { dy=0 }
    if (ev.code === "KeyA") { dx=0 }
    if (ev.code === "KeyD") { dx=0 }
